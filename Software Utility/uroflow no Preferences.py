...
"}")
    ...
    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
        self.Device_setup_pushButton.setText(_translate("MainWindow", "Device Setup"))
        self.PasswordWiFilabel.setText(_translate("MainWindow", "Password *"))
        self.WiFi_setup_label.setText(_translate("MainWindow", "WiFi Setup"))
        self.MQTTusernamelabel.setText(_translate("MainWindow", "Username:"))
        self.UpdatepushButton.setText(_translate("MainWindow", "Update"))
        self.MQTTusernamelabel_2.setText(_translate("MainWindow", "RNDTECH"))
        self.USBPortlabel.setText(_translate("MainWindow", "USB Port:"))
        self.MQTTPortlabel.setText(_translate("MainWindow", "Port:"))
        self.USB_comboBox.setItemText(0, _translate("MainWindow", "SERIAL"))
        self.Serial_setup_label.setText(_translate("MainWindow", "Serial Setup"))
        self.CancelpushButton.setText(_translate("MainWindow", "Cancel"))
        self.waringlabel_2.setText(_translate("MainWindow", "*Max 14 Characters"))
        self.SavepushButton.setText(_translate("MainWindow", "Save"))
        self.waringlabel.setText(_translate("MainWindow", "*Max 14 Characters"))
        self.MQTT_setup_label.setText(_translate("MainWindow", "MQTT Setup"))
        self.SSIDWiFilabel.setText(_translate("MainWindow", "SSID *"))
        self.ConnectpushButton.setText(_translate("MainWindow", "Connect"))
        self.MQTTIPlabel.setText(_translate("MainWindow", "Broker IP:"))
        self.MQTTPortlabel_2.setText(_translate("MainWindow", "1883"))
...
"}")
    ...
    def Generate(checked):
        ...
        canvas.drawString(1.47 * inch, 9.7 * inch, ui10.lineEdit_PatientName.text())
        ...
        # Mobile No. Patient
        canvas.setFont("Helvetica-Bold",10)
        canvas.drawString(5 * inch, 9.25 * inch, "Mobile No. : ")
        canvas.setFont("Times-Roman",10)
        canvas.drawString(5.81 * inch, 9.25 * inch, ui10.lineEdit_MobileNo.text())

        # Patient ID
        canvas.setFont("Helvetica-Bold",10)
        canvas.drawString(5 * inch, 9.7 * inch, "Patient ID : ")
        canvas.setFont("Times-Roman",10)
        canvas.drawString(5.85 * inch, 9.7 * inch, ui10.lineEdit_PatientID.text())

        # Age
        canvas.setFont("Helvetica-Bold",10)
        canvas.drawString(0.5* inch, 9.25 * inch, "Age : ")
        canvas.setFont("Times-Roman",10)
        canvas.drawString(0.9 * inch, 9.25 * inch, ui10.lineEdit_Age.text()+" Yrs")
